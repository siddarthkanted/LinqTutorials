...
namespace LinqTutorialsConsoleApplication.Model
{
    public class Student
    {
        ...
        public static List<Student> GetStudentList()
        {
            ...
            studentList.Add(new Student("sid", "3", 94, 100, 24));
            studentList.Add(new Student("pin", "12", 88, 88, 26));
            studentList.Add(new Student("rak", "22", 72, 68, 30));
            studentList.Add(new Student("dad", "19", 70, 100, 50));
            studentList.Add(new Student("mom", "5", 60, 50, 48));
            studentList.Add(new Student("sid", "1", 60, 50, 48));
            return studentList;
        }
    }
}
